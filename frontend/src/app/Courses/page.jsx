...
export default function CoursesPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100/50 py-12 dark:from-slate-950 dark:to-slate-900/50 transition-colors duration-300">
      <title>Available Courses | Kalinga Computer Education</title>
      <meta name="description" content="Explore our certificate, diploma, and specialized courses designed to equip you with real-world skills and professional competency." />
